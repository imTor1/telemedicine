        ...
        <div className="mt-6 p-4 sm:p-5 rounded-2xl border border-gray-200 bg-white shadow-sm">
          <div className="grid gap-3 md:grid-cols-12">
            ...
            <select
              ...
              className="md:col-span-3 rounded-xl border border-gray-300 bg-white px-4 py-2.5 text-sm outline-none focus:ring-4 focus:ring-emerald-100 focus:border-emerald-400"
            >
              {SPECIALTIES.map((s) => (
        ...
        <div className="mt-8">
          ...
          >
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3">
              ...
              {!loading &&
                doctors.map((d) => (
                  <DoctorCard key={d.id} d={d} onOpen={openBooking} />
                ))}
            </div>
          </Suspense>
        </div>
